...
export declare type ConsoleOutput<Output = string, Input = string> = (message: Input) => Output;
declare type ConsolePrinter = {
    font: {
...
export declare const consolePrinter: ConsolePrinter;
