...
export function getLocalRegistryURL() {
    return localNPMRegistry;
}
export function setLocalRegistryURL(value) {
    localNPMRegistry = new URL("", value).href;
    return localNPMRegistry;
}
export function loadRegistryURLFromLocalSystem() {
    try {
...
export function getNpmAPIURL() {
    return kNpmAPIURL.href.slice(0, -1);
}
export function buildDownloadsURL(pkgName, period) {
