...
function reportScannerDependencies(payload) {
...
function reportScannerAnalysis(_payload) {
    return function* report(logger) {
        while (true) {
            reportScannerLoggerEvents(logger);
            reportScannerDependencies((yield));
        }
    };
}
export const scannerReporter = {
